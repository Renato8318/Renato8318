...
Durante minha trajetória, desenvolvi habilidade para **resolver problemas críticos**, otimizar processos e criar **interfaces modernas com impacto real**.  
...
### 🔹 SessãoPlay
Aplicação de streaming integrada à API TMDB, exibindo filmes e séries.  
